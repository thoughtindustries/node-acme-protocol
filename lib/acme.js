...
ACME.Directory = require( './resources/directory' )

// The logic of the ACME is based around four types of objects:
// registrations, authorizations, challenges, and certificates
ACME.Registration = require( './resources/registration' )
ACME.Application = require( './resources/application' )
ACME.Challenge = require( './resources/challenge' )
ACME.Certificate = require( './resources/certificate' )
